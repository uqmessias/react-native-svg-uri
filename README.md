...
Render SVG images in React Native from an URL or a static file (fork of [`react-native-uri`](https://github.com/vault-development/react-native-svg-uri)).

This was tested with `react-native@0.57.7` and `react-native-svg@9.2.3` (depends on this library)
[react-native-svg](https://github.com/react-native-community/react-native-svg) ([on NPM](https://www.npmjs.com/package/react-native-svg))
